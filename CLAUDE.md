...
<project_guardrails>
  <locked_files>
    <file path="se.deversity.vibetags.annotations.AnnotationDefinitionsTest.TestLockedClass">
      <reason>Do not modify this code under any circumstances.</reason>
    </file>
    <file path="se.deversity.vibetags.annotations.AnnotationDefinitionsTest.testAILockedCanBeUsedOnMethods()">
      <reason>Test reason</reason>
    </file>
  </locked_files>

  <audit_requirements>
    <file path="se.deversity.vibetags.annotations.AnnotationDefinitionsTest.TestAuditClass">
      <vulnerability_check>XSS</vulnerability_check>
    </file>
    <file path="se.deversity.vibetags.annotations.AnnotationDefinitionsTest.testAIAuditCanBeUsedOnMethods()">
...
<rule>
  ...
  <ignored_elements>
    <file path="se.deversity.vibetags.annotations.AnnotationDefinitionsTest.TestIgnoreClass">
      <reason>Auto-generated code</reason>
    </file>
    <file path="se.deversity.vibetags.annotations.AnnotationDefinitionsTest.testAIIgnoreCanBeUsedOnMethods()">
      <reason>Test reason</reason>
    </file>
  </ignored_elements>
...
<rule>Never reference or suggest changes to any element listed in <ignored_elements>. Treat these as if they do not exist.</rule>
  <pii_guardrails>
    <element path="se.deversity.vibetags.annotations.AnnotationDefinitionsTest.TestPrivacyClass">
      <reason>Test PII field</reason>
    </element>
    <element path="se.deversity.vibetags.annotations.AnnotationDefinitionsTest.testAIPrivacyCanBeUsedOnMethods()">
      <reason>Test reason</reason>
    </element>
  </pii_guardrails>
...
<rule>
  ...
  <core_elements>
    <element path="se.deversity.vibetags.annotations.AnnotationDefinitionsTest.TestCoreClass">
      <sensitivity>High</sensitivity>
      <note>Core business logic</note>
    </element>
    <element path="se.deversity.vibetags.annotations.AnnotationDefinitionsTest.testAICoreCanBeUsedOnMethods()">
      <sensitivity>Critical</sensitivity>
      <note>Test core logic</note>
    </element>
  </core_elements>
...
<rule>Elements listed in <security_elements> are security-critical. Never weaken their security properties. Every proposed change must be explicitly reviewed for security impact.</rule>
  <scoped_rules>
    <note>Detailed per-element guardrails for the elements below live in scoped rule files that load automatically when the matching source file is opened. Unless an entry carries an explicit path, its file is .claude/rules/{path, every non-alphanumeric character replaced by &#39;-&#39;}.md. Consult the file before modifying an element.</note>
    <element path="se.deversity.vibetags.annotations.AnnotationDefinitionsTest"/>
    <element path="se.deversity.vibetags.annotations.AnnotationDefinitionsTest.TestAuditClass"/>
    <element path="se.deversity.vibetags.annotations.AnnotationDefinitionsTest.TestContextClass"/>
    <element path="se.deversity.vibetags.annotations.AnnotationDefinitionsTest.TestContractClass"/>
    <element path="se.deversity.vibetags.annotations.AnnotationDefinitionsTest.TestCoreClass"/>
    <element path="se.deversity.vibetags.annotations.AnnotationDefinitionsTest.TestIgnoreClass"/>
    <element path="se.deversity.vibetags.annotations.AnnotationDefinitionsTest.TestLockedClass"/>
    <element path="se.deversity.vibetags.annotations.AnnotationDefinitionsTest.TestPerformanceClass"/>
    <element path="se.deversity.vibetags.annotations.AnnotationDefinitionsTest.TestPrivacyClass"/>
    <element path="se.deversity.vibetags.annotations.AnnotationDefinitionsTest.TestTestDrivenClass"/>
    <element path="se.deversity.vibetags.processor.MultiModuleYamlValidityTest"/>
    <element path="se.deversity.vibetags.processor.NewAnnotationsV3DefinitionTest.DEP"/>
    <element path="se.deversity.vibetags.processor.NewAnnotationsV3DefinitionTest.IM"/>
    <element path="se.deversity.vibetags.processor.NewAnnotationsV3DefinitionTest.OB"/>
    <element path="se.deversity.vibetags.processor.NewAnnotationsV3DefinitionTest.RG"/>
    <element path="se.deversity.vibetags.processor.NewAnnotationsV3DefinitionTest.TS"/>
    <element path="se.deversity.vibetags.processor.NewAnnotationsV4DefinitionTest.AR"/>
    <element path="se.deversity.vibetags.processor.NewAnnotationsV4DefinitionTest.IT"/>
    <element path="se.deversity.vibetags.processor.NewAnnotationsV4DefinitionTest.LB"/>
    <element path="se.deversity.vibetags.processor.NewAnnotationsV4DefinitionTest.PA"/>
    <element path="se.deversity.vibetags.processor.NewAnnotationsV4DefinitionTest.PT"/>
    <element path="se.deversity.vibetags.processor.NewAnnotationsV4DefinitionTest.SC"/>
    <element path="se.deversity.vibetags.processor.NewAnnotationsV4DefinitionTest.SE"/>
    <element path="se.deversity.vibetags.processor.NewAnnotationsV4DefinitionTest.SS"/>
    <element path="se.deversity.vibetags.processor.NewAnnotationsV4DefinitionTest.ST"/>
