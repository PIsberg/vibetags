...
| `TestingRendererTest`, `ModuleIdentityTest` | `TESTING.md` renders nothing in a main round and drops no annotation `AGENTS.md` carries in a test one; which source-set names count as test code (`latest` and `contest` do not) |
