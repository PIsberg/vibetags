...
|---|---|---|---|
| [`SPEC.md`](SPEC.md) | The pre-1.0 design specification for thread-isolated logging, parallel test execution, and the annotation wave that came with it. | Implemented pre-1.0 | [`architecture/testing.md` § Concurrency](../architecture/testing.md#concurrency--thread-isolated-logging), [`ANNOTATIONS.md`](../ANNOTATIONS.md), [`TESTS.md`](../TESTS.md) |
