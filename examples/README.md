...
|---|---|---|
| [`gradle-multimodule/`](gradle-multimodule/) | Subprojects below the root, each with its own `build.gradle` | `-Avibetags.root` at the reactor root. Also the Gradle side's depth fixture: five modules, all 44 annotations, transitive manifests, mirroring, roles, nested output, check mode and all 50 services. |
