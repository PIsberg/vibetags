...
- `com.example.config`: `AsyncTestConfig`, `ParallelTestSettings`
- `com.example.database`: `UserEntity`
- `com.example.legacy`: `LegacyBridgeService`, `OldPaymentApi`
- `com.example.metrics`: `OrderMetrics`
- `com.example.payment`: `PaymentDetails`, `PaymentProcessor`
- `com.example.security`: `SecurityConfig`
- `com.example.service`: `EvidenceBasedShowcase`, `InventoryService`, `LayeredDomainService`, `NewAnnotationsShowcase`, `NotificationService`, `OrderService`, `PricingService`, `PublicPaymentController`, `TransactionalPaymentService`
- `com.example.service.NewAnnotationsShowcase`: `DraftKafkaIntegrationSpike`, `ImmutableProductPrice`, `SandboxTestHelper`, `TaxCalculatorStrategy`
- `com.example.strategy`: `PaymentStrategy`
- `com.example.strategy.impl`: `CreditCardStrategy`
- `com.example.utils`: `I18nMessageHelper`, `StrictUtility`, `StringParser`
