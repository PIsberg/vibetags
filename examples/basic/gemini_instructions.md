...
- `com.example.testing.GoldenPayloadFixtures`: These byte sequences are the partner's recorded settlement responses. Regenerating or reformatting them makes the suite agree with itself and disagree with production.
