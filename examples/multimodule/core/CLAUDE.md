...
<project_guardrails>
  ...
  <contextual_instructions>
    <file path="com.example.multimodule.core.IrGraphFixturesTest">
      <focus>Build IrGraph fixtures through IrGraphFixtures.of(...), never by mutating a graph in place: the engine&#39;s layout cache keys on node identity</focus>
      <avoids>Sharing one fixture graph between cases; the engine mutates what it lays out</avoids>
    </file>
  </contextual_instructions>
</project_guardrails>
